...
namespace Identity.Tests.Unit.Persistence.MSSQL
{
    ...
    public class RolesRepositoryTest : DatabaseTestBase
    {
        ...
        public static IEnumerable<TestCaseData> PaginatedGetTestData
        {
            get
            {
                yield return new TestCaseData(new object[]
                {
                    ...
                    new Pagination(0, 5),
                    RolesRepositoryTest.RolesTestData
                }).SetName($"{nameof(TestGet_WhenPaginationGiven_ThenRolesAreReturned)}(1)");
                yield return new TestCaseData(new object[]
                {
                    RolesRepositoryTest.RolesTestData,
                    new Pagination(0, 2),
                ...
                }).SetName($"{nameof(TestGet_WhenPaginationGiven_ThenRolesAreReturned)}(2)");
                yield return new TestCaseData(new object[]
                {
                    RolesRepositoryTest.RolesTestData,
                    new Pagination(1, 2),
                ...
                }).SetName($"{nameof(TestGet_WhenPaginationGiven_ThenRolesAreReturned)}(3)");
                yield return new TestCaseData(new object[]
                {
                    RolesRepositoryTest.RolesTestData,
                    new Pagination(2, 2),
                ...
                }).SetName($"{nameof(TestGet_WhenPaginationGiven_ThenRolesAreReturned)}(4)");
                yield return new TestCaseData(new object[]
                {
                    RolesRepositoryTest.RolesTestData,
                    new Pagination(3, 2),
                    Enumerable.Empty<RoleDto>()
                }).SetName($"{nameof(TestGet_WhenPaginationGiven_ThenRolesAreReturned)}(5)");
            }
        }
        ...
        [Test]
        public void TestAdd_WhenRoleGiven_ThenRoleIsStored()
        {
            ...
            roleRepository.Add(roleDto);

            RoleDto result = roleRepository.Get(roleId);
        ...
        [Test]
        public void TestUpdate_WhenRoleGiven_ThenRoleIsUpdated()
        {
            var roleId = Guid.NewGuid();
            var roleDto = new RoleDto(
                id: roleId,
        ...
        [Test]
        public void TestRemove_WhenRoleGiven_ThenRoleIsRemoved()
        {
            var roleId = Guid.NewGuid();
            var roleDto = new RoleDto(
                id: roleId,
        ...
        [Test]
        public void TestGet_WhenRoleIdGiven_ThenRoleIsReturned()
        {
            var roleId = Guid.NewGuid();
            var roleDto = new RoleDto(
                id: roleId,
        ...
        public void TestGet_WhenPaginationGiven_ThenRolesAreReturned(
            IEnumerable<RoleDto> roles,
            Pagination pagination,
            IEnumerable<RoleDto> expectedRoles)
        {
            var roleRepository = new RolesRepository(this.IdentityContext);
            roles.ToList().ForEach(r => roleRepository.Add(r));

            IEnumerable<RoleDto> result = roleRepository.Get(pagination);
