...
namespace Identity.Tests.Unit.Domain
{
    ...
    public class ApplicationServiceTest
    {
        ...
        [Test]
        public void TestCreateApplication_WhenNoExceptionsThrown_ThenApplicationIsPersisted()
        {
            ...
            applicationsRepositoryMock.Verify(r => r.Add(It.IsAny<Application>()), Times.Once);
        }

        [Test]
        public void TestCreateApplication_WhenNoExceptionsThrown_ThenApplicationCreatedIsPublished()
        {
        ...
        [Test]
        public void TestCreateApplication_WhenAddApplicationThrowsException_ThenApplicationCreatedIsNotPublished()
        {
            ApplicationCreated applicationCreated = null;
            var eventDispatcherMock = new Mock<IEventDispatcher>();
            eventDispatcherMock
            ...
            applicationsRepositoryMock
                .Setup(p => p.Add(It.IsAny<Application>()))
        ...
        [Test]
        public void TestCreateApplication_WhenGetUserThrowsException_ThenApplicationCreatedIsNotPublished()
        {
            ApplicationCreated applicationCreated = null;
            var eventDispatcherMock = new Mock<IEventDispatcher>();
            eventDispatcherMock
        ...
        [Test]
        public void TestCreateApplication_WhenGetUserReturnsNull_ThenUserNotFoundExceptionIsThrown()
        {
            ApplicationCreated applicationCreated = null;
            var eventDispatcherMock = new Mock<IEventDispatcher>();
            eventDispatcherMock
